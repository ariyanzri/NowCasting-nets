...
def get_args():
    ...
    #                     '--residual',
    #                     help='If y/Y is given, the residual dataset will be used, otherwise the normal dataset will be used.',
    #                     metavar='residual',
    #                     required=True)
...
def create_model(file, experiment_name, dic):
    ...
    X_train, X_valid, y_train, y_valid = train_test(file)
    # X_train, X_valid, y_train, y_valid = train_test_experiment1(file,3)
...
def main():
    ...
    # ds_file = dic['directories']['datasets']+'/train_test.h5'
