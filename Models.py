...
# model = UNET_3D_Both_Class({'input_shape':[9,256,256,1],'activation':'relu',\
#     'optimizer':'SGD','loss':'mse','lr':0.002,'input_bn':True,\
#         'conv_kernel_size':3,'deconv_kernel_size':3,'start_filter':16}).model
# model  = CONV_LSTM_Both_Class({'input_shape':[9,256,256,1],'activation':'relu',\
#     'optimizer':'SGD','loss':'mse','lr':0.002,'input_bn':True,\
#         'conv_kernel_size':3,'deconv_kernel_size':3,'start_filter':16}).model
